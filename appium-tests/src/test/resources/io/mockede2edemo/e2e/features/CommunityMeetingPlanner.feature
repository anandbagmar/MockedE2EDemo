...
Feature: Scenarios for "Community Meeting Planner" app
  ...
  # IS_VISUAL=true CONFIG=./configs/mockede2edemo/mockede2edemo_local_android_config.properties PLATFORM=android TAG=@app ./gradlew runTeswiz
  # IS_VISUAL=true CONFIG=./configs/mockede2edemo/mockede2edemo_local_ios_config.properties PLATFORM=iOS TAG=@app ./gradlew runTeswiz
