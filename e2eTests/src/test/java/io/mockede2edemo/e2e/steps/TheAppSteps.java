...
import io.mockede2edemo.e2e.businessLayer.heartbeat.HeartBeatBL;
import io.mockede2edemo.e2e.businessLayer.theapp.AppBL;
import io.mockede2edemo.e2e.businessLayer.theapp.ClipboardBL;
import io.mockede2edemo.e2e.businessLayer.theapp.EchoBL;
import io.mockede2edemo.e2e.businessLayer.theapp.FileUploadBL;
...
public class TheAppSteps {
    ...
    public void iLoginWithInvalidCredentials(String username, String password) {
        LOGGER.info(System.out.printf(
                ...
                "Platform: '%s'",
                MOCKEDE2EDEMO_TEST_CONTEXT.ME, username, password, Runner.getPlatform()));
        ...
        context.addTestState(MOCKEDE2EDEMO_TEST_CONTEXT.ME, username);
        new AppBL(MOCKEDE2EDEMO_TEST_CONTEXT.ME, Runner.getPlatform()).provideInvalidDetailsForSignup(
                username, password);
    }
    ...
    public void loginWithInvalidCredentials(String userPersona, String username, String password) {
        ...
        LOGGER.info(System.out.printf(
                "LoginWithInvalidCredentials - Persona:'%s', Username: '%s', Password:'%s', " +
                "Platform: '%s'",
                MOCKEDE2EDEMO_TEST_CONTEXT.ME, username, password, onPlatform.name()));
    ...
    public void iStartTheApp() {
        LOGGER.info(System.out.printf("iStartTheApp - Persona:'%s'", MOCKEDE2EDEMO_TEST_CONTEXT.ME));
        Drivers.createDriverFor(MOCKEDE2EDEMO_TEST_CONTEXT.ME, Runner.getPlatform(), context);
        new AppBL(MOCKEDE2EDEMO_TEST_CONTEXT.ME, Runner.getPlatform());
    }
    ...
    public void iSaveInTheClipboard(String content) {
        LOGGER.info(System.out.printf("iStartTheApp - Persona:'%s'", MOCKEDE2EDEMO_TEST_CONTEXT.ME));
        Drivers.createDriverFor(MOCKEDE2EDEMO_TEST_CONTEXT.ME, Runner.getPlatform(), context);
        new ClipboardBL(MOCKEDE2EDEMO_TEST_CONTEXT.ME, Runner.getPlatform()).saveContentInClipboard(
                content);
    }
    ...
    public void iAmOnFileUploadPage() {
        LOGGER.info(System.out.printf("iStartTheApp - Persona:'%s'", MOCKEDE2EDEMO_TEST_CONTEXT.ME));
        Drivers.createDriverFor(MOCKEDE2EDEMO_TEST_CONTEXT.ME, Runner.getPlatform(), context);
        new FileUploadBL(MOCKEDE2EDEMO_TEST_CONTEXT.ME, Runner.getPlatform()).navigationToUploadScreen();
    }
