package com.eot.e2edemo.tests.android;
...
import com.eot.e2edemo.tests.BaseTest;
...
public class CommunityMeetingPlannerAndroidTest extends BaseTest {
    ...
    private static final String ANDROID_PACKAGE = "com.eot.e2edemo";
    ...
    public void setUp(Method testInfo) {
        ...
        // for MainActivity.
        options.setAppWaitActivity("com.eot.e2edemo.MainActivity");
