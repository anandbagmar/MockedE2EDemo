...
Feature: Scenarios for "Community Meeting Planner" app
  ...
  Scenario: Verify Community Meeting Planner workflow against Figma design
    Given I have my Figma design with app name "App Automation Playground", test name "Community Meeting Planner-Android-5-11" and baseline name "Community Meeting Planner-Android-5-11_427" available in Applitools
  ...
  Scenario: Verify Community Meeting Planner workflow against Figma design
    Given I have my Figma design with app name "App Automation Playground", test name "Community Meeting Planner-iOS-5-11" and baseline name "Community Meeting Planner-iOS-5-11_427" available in Applitools
    When I launch the Community Meeting Planner app
    And I run the Community Meeting Planner workflow
    Then I should be back on the home screen

  # IS_VISUAL=true CONFIG=./configs/mockede2edemo/mockede2edemo_local_web_config.properties PLATFORM=web TAG=@figma ./gradlew runTeswiz
  @communityMeetingPlanner @web @figma
  Scenario: Verify Community Meeting Planner workflow against Figma design
    Given I have my Figma design with app name "App Automation Playground", test name "Community Meeting Planner-Web-5-10" and baseline name "Community Meeting Planner-Web-5-10_1280" available in Applitools
    When I launch the Community Meeting Planner app
    And I run the Community Meeting Planner workflow
    Then I should be back on the home screen
